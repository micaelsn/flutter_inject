...
import '../mensagens/session_manager.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i4.AuthRemoteDatasource>(
      () => _i4.AuthRemoteDatasource(get<_i5.Dio>()));
  gh.factory<_i6.IAuthRepository>(() => _i6.AuthRepository(
      get<_i4.AuthRemoteDatasource>(), get<_i3.AuthLocalDatasource>()));
  gh.singleton<_i7.SessionManager>(
      _i7.SessionManager(get<_i6.AuthRepository>()));
  return get;
}
